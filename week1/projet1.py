...
while True:
    ...
    elif a - 5 <= b <= a + 5 and ((level == 1 and not (b < 0 or b > 20)) or (level == 2 and not (b < 0 or b > 50)) or (level == 3 and not (b < 0 or b > 100))):
        print("Le nombre que tu as choisi est très proche.")
    elif a + 5 < b <= a + 20 and ((level == 1 and not (b < 0 or b > 20)) or (level == 2 and not (b < 0 or b > 50)) or (level == 3 and not (b < 0 or b > 100))):
        print("Le nombre que tu as choisi est supérieur.")
    elif a - 20 <= b < a - 5 and ((level == 1 and not (b < 0 or b > 20)) or (level == 2 and not (b < 0 or b > 50)) or (level == 3 and not (b < 0 or b > 100))):
        print("Le nombre que tu as choisi est inférieur.")
    elif a + 20 < b <= 100 and ((level == 1 and not (b < 0 or b > 20)) or (level == 2 and not (b < 0 or b > 50)) or (level == 3 and not (b < 0 or b > 100))):
        print("Le nombre que tu as choisi est trop grand.")
    elif 0 <= b < a - 20 and ((level == 1 and not (b < 0 or b > 20)) or (level == 2 and not (b < 0 or b > 50)) or (level == 3 and not (b < 0 or b > 100))):
